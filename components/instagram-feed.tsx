    ...
    <section className="relative py-20 bg-[rgba(249,250,251,0.5)]" aria-labelledby="instagram-heading">
      <div className="container mx-auto px-4">
        ...
        <ScrollReveal className="text-center" delay={300}>
          <Button
            size="lg"
            className="relative z-20 gap-2 backdrop-blur-md bg-primary/80 hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            asChild
          >
